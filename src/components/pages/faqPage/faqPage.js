        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <p>
              ...
              同事一齊寫一個網頁或者程式。如果覺得寫 Code 好辛苦，你亦都可以做
              IT Consultant 為顧客提供 IT 方面嘅支援同意見，或者做 IT Research
              寫論文。而科大嘅 CS
          ...
          <section className="section">
            <h2 className="highlighted">
              BEng in Computer Science (COMP) 同埋 BSc in Computer Science
              (COSC) 有咩分別㗎？
            </h2>
            <p>
              ...
              同埋 FYP，而 COSC 同學揀 electives
              亦會有比較少嘅限制，方便同學讀好 first major
              嘅課程，同埋有機會參與 Research。不過 COSC
              嘅收生要求比較高，亦都淨係俾已經有 first major
              嘅同學報讀，如果同學真係對 CS 好有興趣，我哋都會建議你報讀返 BEng
          ...
          <section className="section">
            ...
            <p>
              由於科大 Engine 係 School Based
              收生嘅，同學要等一年先可以揀讀心儀嘅 Major。所有想經 JUPAS 讀科大
              CS 嘅同學一定要先報讀 JS5200，即係 HKUST - Engineering 。大部份嘅
              Engineering Major ，包括 Computer Science，都係以 Best 24 Credits
              決定收生，喺未有 Major 嘅 Freshmen Year，同學要努力考好啲 Final
              Exams ，確保自己嘅成績夠入 CS Major 呀！
            </p>
          </section>
          <section className="section">
            <h2 className="highlighted">
            ...
            <p>
              ...
              Science Subject 先會有 Double Count。如果你中學冇讀理科，又冇讀
              ICT ，咁你就無緣經 Jupas 入讀科大 CS 喇！
            </p>
            <p>
          ...
          <section className="section">
            ...
            <p>
              ...
              英文至少有 3 又或者 IELTS 至少有
              6.0。咁入到系統之後你就可以將「BEng in Computer
          ...
          <section className="section">
            ...
            <p>
              ...
              先可以畢業，如果你係經 direct entry 入嚟嘅話就會有 21 個 credit
              自動 transfer 比你，而其餘嘅 credit 就要睇下你喺之前嘅院校讀過嘅
              course 有冇同科大嘅 course 相等，你可以上{" "}
              <a
              ...
              credit。咁如果你 transfer 到 60 個 credit 嘅話，你只需要係嚟緊嘅
              2-3 年讀埋剩餘嘅 60 個 credit 就可以畢業喇。
            </p>
          </section>
          <section className="section">
            <h2 className="highlighted">
          ...
          <section className="section">
            ...
            <p>
              ...
              Camp，招募新血同埋推出靚靚 Soc Tee Soc Product 嘅 CSESS
              Orientation Week，同埋有得食有得玩有得打卡嘅 CSE Festival！
            </p>
            <p>
